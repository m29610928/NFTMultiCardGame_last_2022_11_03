...
public class DragTextSlotNft : UI_Base
{
    static public DragTextSlotNft instance;

    public RectTransform rt;
    public Canvas canvas;

    [SerializeField]
    TextSlotNft dragSlot;
    ...
    public void SetDragSlot(TextSlotNft _slot)
    {
        dragSlot = _slot;
        card = _slot.card;
    ...
    public TextSlotNft GetDragSlot()
    {
        return dragSlot;
    }
